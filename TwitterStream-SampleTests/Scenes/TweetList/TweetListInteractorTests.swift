...
class TweetListInteractorTests: XCTestCase {
    var subject: TweetListInteractor!
    var presenterMock: TweetListPresenterMock!
    var workerMock: TweetListWorkerMock!

    override func setUpWithError() throws {
        presenterMock = TweetListPresenterMock()
        workerMock = TweetListWorkerMock()

        subject = TweetListInteractor(presenter: presenterMock, worker: workerMock)
